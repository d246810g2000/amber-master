...
const CustomTooltip = ({ active, payload }: any) => {
  if (active && payload && payload.length) {
    ...
    return (
      <div className="bg-zinc-950/95 backdrop-blur-xl border border-white/10 p-4 rounded-2xl shadow-2xl ring-1 ring-white/10 min-w-[180px]">
        <p className="text-[10px] font-black text-zinc-500 uppercase tracking-[0.2em] mb-3 border-b border-white/5 pb-2">
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between gap-6">
            <div className="flex items-center gap-2.5">
              ...
              <span className="text-[11px] font-bold text-zinc-400">生涯戰力</span>
            </div>
          ...
          <div className="flex items-center justify-between gap-6">
            <div className="flex items-center gap-2.5">
              ...
              <span className="text-[11px] font-bold text-zinc-400">即時戰力</span>
            </div>
            <span className="text-xs font-black text-white tabular-nums">
          ...
          <div className="pt-2 border-t border-white/5 flex items-center justify-between">
            <span className="text-[10px] font-black text-zinc-500 uppercase">競技狀態</span>
            <span className={`text-[10px] font-black px-2 py-0.5 rounded-md ${isHot ? 'bg-amber-500/10 text-amber-500' : 'bg-zinc-500/10 text-zinc-500'}`}>
  ...
  return (
    <div className="bg-zinc-900/40 border border-white/5 rounded-[3rem] p-6 sm:p-10 shadow-2xl">
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6 sm:gap-0 mb-8 sm:mb-10">
        <h3 className="text-sm font-black text-white uppercase tracking-[0.2em] flex items-center gap-3 shrink-0">
        ...
        <div className="flex gap-4 sm:gap-6 self-start sm:self-auto flex-wrap">
          <div className="flex items-center gap-2">
            ...
            <div className="flex flex-col">
              <span className="text-[10px] font-black text-zinc-200 uppercase tracking-widest">生涯戰力</span>
              <span className="text-[8px] font-bold text-zinc-500">長期穩定的技術累積</span>
            </div>
          </div>
          <div className="flex items-center gap-2">
            <div className="w-2.5 h-2.5 rounded-full bg-amber-500 shadow-lg shadow-amber-500/20" />
            <div className="flex flex-col">
              <span className="text-[10px] font-black text-zinc-200 uppercase tracking-widest">即時戰力</span>
              <span className="text-[8px] font-bold text-zinc-500">當前手感與競技狀態</span>
            </div>
          </div>
        </div>
      </div>
