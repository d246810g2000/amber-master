...
export const BadmintonLoader: React.FC<BadmintonLoaderProps> = ({ fullScreen }) => {
  return (
    <div className={cn(
      "flex flex-col items-center justify-center py-10 animate-in fade-in duration-700",
      fullScreen && "fixed inset-0 z-[9999] bg-[#F0F4F1] dark:bg-slate-950"
    )}>
